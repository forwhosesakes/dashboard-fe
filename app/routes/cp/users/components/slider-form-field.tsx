    ...
    <>
      <Controller
        ...
        render={({ field: { onChange, value }, fieldState }) => {
          ...
          const [sliderValue, setSliderValue] = useState<number>(value as number ?? 0);
          const [switchState, setSwitchState] = useState(value && value  as number>0);
          ...
          return (
            <>
              ...
              <div className=" flex-[1_0_0]">
              {hasSlider&&   <>  <p className="font-medium text-right mb-2 ">
                    نسبة قياس المؤشر
                  </p>
