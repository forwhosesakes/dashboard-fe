...
import { TrendingUp, ArrowUpRight, TrendingDown, ArrowDownLeft } from "lucide-react";
        ...
        <div className={cn(
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 w-full md:w-1/2 justify-center items-center px-4 py-3 border-2 rounded-xl border-[#9C9C9C] shadow-[0px_1px_2px_0px_rgba(255,255,255,0.00)]">
            <div className="flex h-fit justify-center items-center text-[#CECFD2] py-[2px] gap-1 pl-[6px] pr-2 bg-[#0C0E12] border rounded-lg text-sm">
              آخر ثلاث شهور{" "}
              {Number(props.indicators?.FINANCIAL_PERF)<0?<ArrowDownLeft className="text-red-500 font-bold w-4 h-4 min-w-4 min-h-4" />:<ArrowUpRight className="text-accent font-bold w-4 h-4 min-w-4 min-h-4" />}
...
:<UnderConstructionCard/>}
        ...
        <div className={cn(
          ...
          <div className="flex flex-col justify-center w-[25%] items-center p-5 gap-2 border-2 rounded-xl border-[#9C9C9C] shadow-[0px_1px_2px_0px_rgba(255,255,255,0.00)] ">
            <div className="flex h-fit justify-center items-center text-[#CECFD2] py-[2px] gap-1 pl-[6px] pr-2 bg-[#0C0E12] border rounded-lg text-sm">
              آخر ثلاث شهور{" "}
              {Number(props.indicators?.ADMIN_TO_TOTAL_EXPENSES)<0?<ArrowDownLeft className="text-red-500 font-bold w-4 h-4 min-w-4 min-h-4" />:<ArrowUpRight className="text-accent font-bold w-4 h-4 min-w-4 min-h-4" />}
...
:<UnderConstructionCard/>}
          ...
          <div className="flex flex-col justify-center w-[25%] items-center p-5 gap-2 border-2 rounded-xl border-[#9C9C9C] shadow-[0px_1px_2px_0px_rgba(255,255,255,0.00)] ">
            <div className="flex h-fit justify-center items-center text-[#CECFD2] py-[2px] gap-1 pl-[6px] pr-2 bg-[#0C0E12] border rounded-lg text-sm">
              آخر ثلاث شهور{" "}
              {Number(props.indicators?.ABL_COVER_OBLIG)<0?<ArrowDownLeft className="text-red-500 font-bold w-4 h-4 min-w-4 min-h-4" />:<ArrowUpRight className="text-accent font-bold w-4 h-4 min-w-4 min-h-4" />}
...
:<UnderConstructionCard/>}
          ...
          <div className="flex flex-col justify-center w-[25%] items-center p-5 gap-2 border-2 rounded-xl border-[#9C9C9C] shadow-[0px_1px_2px_0px_rgba(255,255,255,0.00)] ">
            <div className="flex h-fit justify-center items-center text-[#CECFD2] py-[2px] gap-1 pl-[6px] pr-2 bg-[#0C0E12] border rounded-lg text-sm">
              آخر ثلاث شهور{" "}
              {Number(props.indicators?.FUND_RAISING_TO_TOTAL_EXPENSES)<0?<ArrowDownLeft className="text-red-500 font-bold w-4 h-4 min-w-4 min-h-4" />:<ArrowUpRight className="text-accent font-bold w-4 h-4 min-w-4 min-h-4" />}
...
:<UnderConstructionCard/>}
          ...
          <div className="flex flex-col justify-center  w-[21.5%] items-center p-5 gap-5 border-2 rounded-xl border-[#9C9C9C] shadow-[0px_1px_2px_0px_rgba(255,255,255,0.00)]">
            ...
            <div className="flex h-fit justify-center items-center text-[#CECFD2] py-[2px] gap-1 pl-[6px] pr-2 bg-[#0C0E12] border rounded-lg text-sm">
              آخر ثلاث شهور{" "}
              {Number(props.indicators?.DONAT_MONEY_RAISING)<0?<ArrowDownLeft className="text-red-500 font-bold w-4 h-4 min-w-4 min-h-4" />:<ArrowUpRight className="text-accent font-bold w-4 h-4 min-w-4 min-h-4" />}
        ...
        <div className="flex justify-between w-full border-2 p-5 gap-4 rounded-xl border-[#9C9C9C] shadow-[0px_1px_2px_0px_rgba(255,255,255,0.00)]">
          ...
          <div id="barChart" className="w-[51%]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={[
                  { name: '', value: Number(props.indicators["SUST_EXPENSEES_TO_REV"]) },
                  { name: '', value: Number(props.indicators.REV_FIN_SUST_TO_TOTAL_EXPENSES) },
                  { name: '', value: Number(props.indicators["SUST_TO_TOTAL_EXPENSES"]) },
                ]}
