...
export const clientFormDataSchema = z.object({
  ...
  // File validations
  logo: z.instanceof(File, { message:  "يرجى رفع صورة للشعار"}),
  officialDocs: z.instanceof(File, { message: "يرجى رفع نسخ من المستندات الرسمية " }),
  operationalPlanImage: z.instanceof(File, { message: "يرجى رفع نسخ من المستندات المطلوبة " }),
  repSpeach: z.instanceof(File, { message: "يرجى رفع نسخ من المستندات المطلوبة " }),
  licenseImage: z.instanceof(File, { message: "يرجى رفع نسخ من المستندات المطلوبة " }),
  contractImage: z.instanceof(File, { message: "يرجى رفع نسخ من المستندات المطلوبة " }),
  additionalDocs: z.instanceof(File, { message: "يرجى رفع نسخ من المستندات المطلوبة " }),
