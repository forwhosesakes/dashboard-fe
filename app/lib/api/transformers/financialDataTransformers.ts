...
export function transformFinancialEntries(
    ...
    return entries.map(entry => {
      const sustainabilityAssets = createParentNode("TOTAL_SUSTAINABILITY_ASSETS", entry.TOTAL_SUSTAINABILITY_ASSETS,true, {
      ...
      const netRestrictedAssets = createParentNode("TOTAL_NET_RESTRICTED_ASSETS_AND_WAQF_CASH", 
        entry.TOTAL_NET_RESTRICTED_ASSETS_AND_WAQF_CASH,true, {
      ...
      const administrativeExpenses = createParentNode("TOTAL_ADMINISTRATIVE_GENERAL_AND_GOVERNANCE_EXPENSES", 
        entry.TOTAL_ADMINISTRATIVE_GENERAL_AND_GOVERNANCE_EXPENSES,true, {
      ...
      const programExpenses = createParentNode("TOTAL_PROGRAM_AND_ACTIVITY_EXPENSES",
        entry.TOTAL_PROGRAM_AND_ACTIVITY_EXPENSES,true, {
      ...
      const sustainabilityExpenses = createParentNode("TOTAL_FINANCIAL_SUSTAINABILITY_EXPENSES",
        entry.TOTAL_FINANCIAL_SUSTAINABILITY_EXPENSES,true, {
      ...
      const totalExpenses = createParentNode("TOTAL_EXPENSES", entry.TOTAL_EXPENSES, true,{
      ...
      const sustainabilityReturns = createParentNode("TOTAL_SUSTAINABILITY_RETURNS", entry.TOTAL_SUSTAINABILITY_RETURNS,true, {
      ...
      const totalDonations = createParentNode("TOTAL_DONATIONS", entry.TOTAL_DONATIONS,true, {
      ...
      const programActivityRevenues = createParentNode("PROGRAM_AND_ACTIVITY_REVENUES", entry.PROGRAM_AND_ACTIVITY_REVENUES,true, {
        RESTRICTED_DESIGNATED_PROGRAM_AND_ACTIVITY_FEES: createNode("RESTRICTED_DESIGNATED_PROGRAM_AND_ACTIVITY_FEES", 
          ...
          UNRESTRICTED_REVENUE: createNode("UNRESTRICTED_REVENUE", 
            entry.UNRESTRICTED_REVENUE),

      });
      
      const importantValues = createParentNode("IMPORTANT_VALUES_AND_PERCENTAGES_SUPPORTING_FINANCIAL_RESOURCES", 
        entry.IMPORTANT_VALUES_AND_PERCENTAGES_SUPPORTING_FINANCIAL_RESOURCES,false, {
