...
return entries.map(entry=>{
    return{
        ...
        children:{
            ...
            DISBURSED_AMOUNTS_QUARTERLY:createParentNode("DISBURSED_AMOUNTS_QUARTERLY",entry.DISBURSED_AMOUNTS_QUARTERLY,{
            ...
            APPROVED_AMOUNTS_QUARTERLY:createParentNode("APPROVED_AMOUNTS_QUARTERLY",entry.APPROVED_AMOUNTS_QUARTERLY,{
